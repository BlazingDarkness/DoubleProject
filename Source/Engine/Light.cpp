...
namespace Scene
{
	...
	Light::Light(const gen::CVector3& colour, const float brightness) : SceneNode()
	{
		m_Colour = colour;
	...
	Light::Light(const gen::CVector3 colour, const float brightness,
				 const gen::CVector3& pos, const gen::CVector3& rot, const gen::CVector3& scale) : SceneNode(pos, rot, scale)
	{
		m_Colour = colour;
		m_Brightness = brightness;
	}
	...
	Light::Light(const gen::CVector3& colour, const float brightness, const gen::CMatrix4x4& mat) : SceneNode(mat)
	{
		m_Colour = colour;
		m_Brightness = brightness;
	}
	...
	const gen::CVector3 Light::kWhite	= CVector3(1.0f, 1.0f, 1.0f);
